...
[2]: https://github.com/velero-io/velero/blob/v1.3.0/pkg/plugin/logger.go
[3]: https://github.com/velero-io/velero/blob/v1.3.0/pkg/restore/restic_restore_action.go
