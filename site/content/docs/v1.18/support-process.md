...
For more information about Velero testing and supported Kubernetes versions, see Velero's [compatibility matrix](https://github.com/velero-io/velero/blob/v1.18.0/README.md#velero-compatibility-matrix).
