...
If we have missed addressing insensitive verbiage anywhere, please let us know on the [#velero slack channel](https://kubernetes.slack.com/archives/C6VCGP4MT) or by [creating issues on github](https://github.com/velero-io/velero/issues/new/choose) and we will address it immediately.
...
You can find more details about the design in the [design document for this feature](https://github.com/velero-io/velero/blob/main/design/restore-hooks.md).
...
These were just some highlights of the release. You can always find more information about the release in the [release change log](https://github.com/velero-io/velero/blob/v1.5.1/changelogs/CHANGELOG-1.5.md). 
