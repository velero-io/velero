...
func (in *BackupStorageLocationSpec) DeepCopyInto(out *BackupStorageLocationSpec) {
	*out = *in
	...
	if in.Worker != nil {
		...
		*out = new(BackupStorageLocationWorker)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackupStorageLocationWorker) DeepCopyInto(out *BackupStorageLocationWorker) {
	*out = *in
	if in.PodLabels != nil {
	...
	if in.TokenVolumes != nil {
		in, out := &in.TokenVolumes, &out.TokenVolumes
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupStorageLocationWorker.
func (in *BackupStorageLocationWorker) DeepCopy() *BackupStorageLocationWorker {
	if in == nil {
		return nil
	}
	out := new(BackupStorageLocationWorker)
